...
export default function Footer() {
    ...
    return (
        <div className="relative bg-lime-950 text-white bg-cover bg-center" >
            ...
            <div className="flex flex-col-reverse sm:flex-row justify-between items-center px-12 pb-4">
                {/* Social Icons */}
                ...
                <div className="flex items-center gap-4">
                    <button className=""><Link to='/about'>{translatedText.about}</Link></button>
                    <button className=""><Link to='/products'>{translatedText.products}</Link></button>
                    <button className=""><Link to='/careers'>{translatedText.careers}</Link></button>
                </div>
            </div>
        </div>
    );
    ...
    switch (language) {
        ...
        case "Hindi":
            return {
                ...
                cropProtection: "क्रॉप प्रोटेक्शन",
                insectisides: "कीटनाशक",
                fungicides: "फंगाइसाइड्स",
                herbicides: "हर्बिस",
                micronutrients: "माइक्रोन्यूट्रिएंट्स फर्टिलाइझर्स",
                biofertilisers: "जैविक खाद",
                pesticides: "पेस्टिसाइड्स",
