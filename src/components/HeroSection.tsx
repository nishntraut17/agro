...
export default function HeroSection() {
    ...
    return (
        <div className="min-h-screen md:pt-20 relative">
            <div className="flex flex-col lg:flex-row items-center justify-center text-green-950 px-8 lg:px-20 lg:py-12">
                <div className="p-20 sm:p-0 lg:w-2/3 lg:px-8 mb-8 lg:mb-0 text-center lg:text-left">
                    ...
                    <p className="text-base lg:text-lg leading-relaxed font-semibold">
                        ...
                        {language === "Hindi" && (
                            <>
                                एन्जो-केम एग्रोकेमिकल किसान समृद्धि के लिए प्रीमियम कृषि उत्पाद प्रदान करने के लिए समर्पित है। फसल संरक्षण, माइक्रोन्यूट्रिएंट्स, कीटनाशक और उर्वरकों के अग्रणी निर्माता के रूप में, हम कृषि उत्पादकता और स्थायित्व को बढ़ाने के लिए प्रतिबद्ध हैं। हमारे नवाचारी समाधान फसल संरक्षण उत्पादों, उर्वरकों, पौधों के विकास नियंत्रक (पीजीआर), कीटनाशकों और माइक्रोन्यूट्रिएंट समाधानों की एक विस्तृत श्रेणी को समावेश करते हैं। किसानों को सशक्त बनाने और समुदायों को पोषित करके, हम विज्ञान और प्रौद्योगिकी का उपयोग करके एक अधिक संवेदनशील और समृद्ध कृषि उद्योग बनाने में सहायता करते हैं।
                            </>
                        )}
                        {language === "Marathi" && (
                            <>
                                एन्जो-केम अॅग्रोकेमिकल शेतकऱ्यांना समृद्धीसाठी प्रीमियम कृषी वस्त्रे पुरवण्यास समर्पित आहे. फळांची संरक्षण, मायक्रोन्यूट्रिएंट्स, कीटकनाशके आणि खते यांच्या अग्रणी निर्माता म्हणून, आम्ही कृषी उत्पादकता आणि सततत्वाच्या मार्गाने आग्रही आहोत. आमचे नवीनतम उपाय फळांची संरक्षण उत्पादने, खते, वनस्पती विकास नियंत्रक (पीजीआर), कीटकनाशके आणि मायक्रोन्यूट्रिएंट समाधाने आढळतात. शेतकऱ्यांना सशक्त करून आणि समुदायांना पोषित करून, आम्ही विज्ञान आणि प्रौद्योगिकीचा वापर करून एक अधिक प्रतिस्पर्धी आणि समृद्ध कृषी उद्योग तयार करतो.
                            </>
                        )}
                    </p>
                </div>
